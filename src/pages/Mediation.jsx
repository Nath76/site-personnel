    ...
    <main className="page-main section mediation-page-v2">
      ...
      <section className="urban-security-teaching">
        <div className="teaching-copy">
          ...
          <p>
            ...
            catégoriser, cartographier puis discuter les situations urbaines afin
            de transformer des indices dispersés en diagnostic partageable.
          </p>
      ...
      <section className="mediation-part part-two">
        ...
        <div className="thinking-text">
          ...
          <p>
            Cette réflexion s’appuie notamment sur deux mémoires de master
            consacrés aux dispositifs numériques, à la connaissance et aux
        ...
        <div className="concept-map">
          {concepts.map((concept, index) => (
            <article
              className={`concept-bubble bubble-${index + 1}`}
              key={concept.title}
            >
              <h3>{concept.title}</h3>
              <p>{concept.text}</p>
      ...
      <section className="mediation-part part-three">
        ...
        <div className="memoire-row">
          <article className="memoire-card">
            ...
            <div>
              <h3>
                ...
                intelligence stratégique : quelle contribution à la formation en
                travail social ?
              </h3>
          ...
          <article className="memoire-card">
            ...
            <div>
              <h3>
                De la veille aux connaissances actionnables : quelle
                infovisualisation en appui aux politiques publiques ?
              </h3>
