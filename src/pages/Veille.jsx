...
const explorations = [
  ...
  {
    title: "Veille éditoriale, débats publics et productions intellectuelles",
    kicker: "Analyse · Centre d’études et de prospective",
    image: "/site-personnel/images/veille-editoriale-cep.jpg",
    imageClass: "image-contain",
    text:
      "Une analyse des productions intellectuelles, débats publics et sources suivies par un bulletin de veille, pour comprendre les évolutions des thèmes, des canaux et des formes de circulation des savoirs.",
    link: "#",
    linkLabel: "Lire l’analyse",
  },
];
...
const formes = [
  {
    ...
    imageClass: "image-contain",
    text:
      "Une forme éditoriale destinée à sélectionner, hiérarchiser et reformuler des signaux pour les rendre exploitables.",
  },
  {
    title:
    ...
    imageClass: "image-contain",
    text:
      "Une publication synthétique sur les coopérations de recherche agricoles et agroalimentaires dans l’océan Indien.",
    link:
    ...
    <main className="page-main section veille-page">
      <section className="veille-hero">
        <div className="veille-hero-copy">
          ...
          <p>
            La veille suppose de concevoir des dispositifs capables de rendre des
            signaux plus lisibles, comparables et exploitables.
          </p>
        </div>
